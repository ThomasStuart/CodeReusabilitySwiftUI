...
struct GolfAIButton: View {
    ...
    var borderColor: Color    = Color.golfAiMainTheme
            ...
            textObject
                ...
                .background(
                    ...
                    RoundedRectangle(cornerRadius: self.cornerRadius)
                        ...
                        .foregroundColor( self.isFilled ? Color.golfAiMainTheme : Color.clear )
            )
        }
    }
}
    ...
    static var previews: some View {
        Group {
            GolfAIButton(action: { print("hello") } ,
                         textObject: iText(text:"Swing Again", color: Color.golfAiMainTheme) )
